...
echo -e "\nEnter password for decryption ANDROIDMANIFEST_PASSWORD:"
read -s ANDROIDMANIFEST_PASSWORD
...
echo -e "\nEnter password for decryption INFOPLIST_PASSWORD:"
read -s INFOPLIST_PASSWORD
...
cd ..
openssl aes-256-cbc -d -pbkdf2 -in android/app/src/main/AndroidManifest.xml.enc -out android/app/src/main/AndroidManifest.xml -k $ANDROIDMANIFEST_PASSWORD
